...
const mapDispatchToProps = (dispatch) => {
  return {
    getCow: (id) => dispatch(gettingParticularCategory(id)),
    updateCow: (id, data) => dispatch(updatingCategory(id, data)),
  };
};
