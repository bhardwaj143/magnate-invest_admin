...
const ThisWeekTable = (props) => {
  ...
  const getData = async () => {
    setLoader(true);
    const res = await props.todayRegisteredUsers(1, null, 1000, "byThisWeek");
...
export default connect(mapStateToProps, mapDispatchToProps)(ThisWeekTable);
